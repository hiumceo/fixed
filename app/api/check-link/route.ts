...
export async function GET(request: Request) {
  ...
  const stream = new ReadableStream({
    async start(controller) {
      ...
      try {
         ...
         * IMPORTANT:
         *
         * We intentionally keep headless:false.
         *
         * This preserves the headed-browser environment that
         * produced the working link results.
         *
         * The browser window is positioned far outside the
         * visible desktop instead of using headless mode.
         *
         * The customer therefore does not see a browser popup,
         * while Chromium still runs as a normal headed browser.
         */
  ...
  new Promise<{
    ...
    downloadResolve = resolve;
         ...
         * ------------------------------------------------------
         *
         * Forward everything emitted by the page.
         *
         * This includes:
         *
         * - LaunchDarkly messages
         * - resource errors
         * - Apollo messages
         * - Proven Checker output
         */
         ...
         *
         * This preserves the timing behavior from the first
         * working headed version.
         */
        ...
        try {
           ...
           *
           * If LOAD does not arrive within 30 seconds,
         ...
         * ------------------------------------------------------
         *
         * The countdown starts AFTER the browser LOAD event.
         */
        ...
        /*
         * ------------------------------------------------------
         * START PROVEN LINK CHECKER
         * ------------------------------------------------------
         *
         * The Proven Checker is completely untouched.
         */

        send({
          type: "status",
          message:
            "Starting Broken Link Checker v1124...",
        });
